...
const Grid = function() {
   ...
   * @returns {Array}
   */
  this.getHeaderVisibleItems = async () => {
   ...
   */
  this.getTable = css => s.e2e.getElementBy('css', css || 'div[class*="__table"]');
   ...
   * @returns {*}
   */
  this.tableHeaderItems = $table => s.e2e.getElementsInsideOfBy('th.k-header', $table);
  ...
  this.tableCells = $row => s.e2e.getElementsInsideOfBy('.k-master-row td', $row);
